...
export const metadata: Metadata = {
  title: "RNR Automotive Privacy Policy",
  keywords:
...
export default function PrivacyPolicy() {
  return (
    <div className="w-full h-auto bg-primary mt-20 py-5">
      <h1 className="w-full text-center text-4xl py-3">Privacy policy</h1>
      <div className="font-sans px-10">
        <p className="text-sm mb-2">Last updated: June 30, 2024</p>
        ...
        <h2 className="text-center text-2xl">Interpretation and Definitions</h2>
        <h3 className="text-center text-2xl mb-2">Interpretation</h3>
        <p className="mb-5">
        ...
        <h3 className="text-center text-2xl">Definitions</h3>
        ...
        <ul className="mb-10">
          ...
          <li className="mb-2">
            ...
            this Agreement) refers to RNR Automotive, 15 Island street,
            Deneysville, 1932.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to RNR Automotive, accessible from{" "}
            <a
              href="www.rnrautomotive.co.za"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.rnrautomotive.co.za
            </a>
          </li>
          <li className="mb-2">
        ...
        <h4 className="text-center text-2xl font-medium mb-2">Personal Data</h4>
        <p className="mb-5">
        ...
        <h4 className="text-center text-2xl font-medium mb-5">Usage Data</h4>
        <p className="mb-2">
        ...
        <h2 className="text-center text-2xl font-medium mb-5">Contact Us</h2>
        <p className="mb-2">
        ...
        <ul className="mb-10">
          <li>
            <p>By email: rnr2service@gmail.com</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>By phone number: 066 206 2317</p>
          </li>
        </ul>
      </div>
    </div>
